      ...
      <div class="surface strip cta-band">
        ...
        <div class="btns">
          <a href="https://wa.me/5517997176407?text=Ol%C3%A1!%20Tenho%20interesse%20em%20ser%20agente%20recrutador%20da%20DMaior%20Agency.%20Como%20funciona%3F" target="_blank" rel="noopener noreferrer" class="btn-grad">
            <svg viewBox="0 0 24 24" width="17" height="17" fill="currentColor" aria-hidden="true"><path d="M12.04 2c-5.46 0-9.91 4.45-9.91 9.91 0 1.75.46 3.45 1.32 4.95L2 22l5.25-1.38a9.9 9.9 0 0 0 4.79 1.22h.01c5.46 0 9.91-4.45 9.91-9.91 0-2.65-1.03-5.14-2.9-7.01A9.82 9.82 0 0 0 12.04 2Zm0 1.67c2.2 0 4.27.86 5.82 2.42a8.19 8.19 0 0 1 2.41 5.82c0 4.54-3.69 8.24-8.24 8.24-1.48 0-2.93-.4-4.19-1.15l-.3-.18-3.12.82.83-3.04-.2-.31a8.16 8.16 0 0 1-1.26-4.37c0-4.54 3.7-8.25 8.25-8.25Zm-4.6 4.52c-.22 0-.57.08-.87.41-.3.33-1.15 1.13-1.15 2.75s1.18 3.18 1.35 3.4c.16.22 2.3 3.68 5.66 5 2.8 1.1 3.37.88 3.98.83.61-.05 1.97-.8 2.25-1.58.28-.78.28-1.44.2-1.58-.09-.14-.31-.22-.64-.39-.33-.16-1.97-.97-2.27-1.08-.3-.11-.53-.16-.75.17-.22.33-.86 1.08-1.06 1.3-.19.22-.39.25-.72.08-.33-.17-1.4-.52-2.66-1.65-.98-.88-1.65-1.96-1.84-2.29-.19-.33-.02-.5.15-.67.15-.15.33-.39.5-.58.16-.2.22-.33.33-.55.11-.22.06-.41-.03-.58-.08-.17-.75-1.81-1.03-2.48-.27-.65-.54-.56-.75-.57l-.64-.01Z"/></svg>
            Quero ser agente
          </a>
