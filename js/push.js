...
(function () {
  ...
  function injetarCss() {
    ...
    s.textContent = [
      ...
      'padding:9px 14px;background:linear-gradient(90deg,#0e1524,#141b2e);',
      'border-bottom:1px solid rgba(0,212,212,.18);color:#e9ecf6;font:14px/1.35 system-ui,-apple-system,sans-serif}',
      '#dmPushConvite .dm-ic{width:18px;height:18px;flex-shrink:0;color:#00d4d4;display:inline-flex}',
      ...
      'cursor:pointer;white-space:nowrap;color:#04121b;background:linear-gradient(135deg,#3b82f6,#00d4d4)}',
      ...
      'justify-content:center;border:0;background:transparent;color:#8a93b8;cursor:pointer;border-radius:8px}',
      '#dmPushConvite .dm-x:hover{background:rgba(255,255,255,.06);color:#e9ecf6}',
      ...
      '#dmPushMount .dm-h .dm-ic{width:16px;height:16px;color:var(--cyan,#00d4d4);display:inline-flex}',
      ...
      '#dmPushMount .dm-txt b{font-size:.85rem;color:var(--text,#e9ecf6);font-weight:600}',
      '#dmPushMount .dm-txt .dm-hint{font-size:.72rem;color:var(--muted,#8a93b8)}',
      '#dmPushMount .dm-push-status{font-size:.78rem;margin:6px 0 2px;display:flex;gap:6px;align-items:flex-start;color:var(--muted,#8a93b8)}',
      ...
      '#dmPushMount .dm-push-status.warn{color:#ffce56}',
      '#dmPushMount .dm-test{margin-top:8px;background:none;border:1px solid var(--border,#2a3350);',
      'color:var(--cyan,#00d4d4);padding:7px 12px;border-radius:10px;font-family:var(--dm-font-title,"Rajdhani",sans-serif);',
      'font-weight:700;font-size:.72rem;text-transform:uppercase;letter-spacing:.04em;cursor:pointer;',
      'display:inline-flex;align-items:center;gap:6px}',
      '#dmPushMount .dm-test:hover{background:rgba(0,212,212,.12)}',
      '#dmPushMount .dm-test:disabled{opacity:.5;cursor:default}',
      '#dmPushMount .dm-test svg{width:13px;height:13px}',
      // ── toggle switch (azul quando ativo) ──
      ...
      '.dm-switch .dm-sl{position:absolute;inset:0;cursor:pointer;background:#3a3f52;border-radius:26px;transition:.25s}',
      ...
      '.dm-switch input:checked + .dm-sl{background:linear-gradient(135deg,#3b82f6,#00d4d4)}',
